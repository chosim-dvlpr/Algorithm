...
width = dot_jmax[-1][1] - dot_jmax[0][1]
height = dot_imax[-1][0] - dot_imax[0][0]

# small_width = dot_jmax[]
...
# temp : [(30, -160), (30, -100), (50, -100)]

small_rec = abs((temp[0][0]-temp[-1][0]) * (temp[0][1]-temp[-1][1]))
total_rec = width * height
